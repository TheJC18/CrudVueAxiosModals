...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    openEditCategoryModal: function openEditCategoryModal(category) {
      this.editMode = true;
    ...
    openDeleteCategoryModal: function openDeleteCategoryModal(id) {
    ...
    cancelDeleteCategory: function cancelDeleteCategory() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this2.axios.put("/api/category/".concat(_this2.category.id), _this2.category).then(function (response) {
      ...
      [
        _c(
          "b-button",
          {
            ...
            on: { click: _vm.openAddCategoryModal }
          },
          [_vm._v("Add Category")]
        )
      ],
                        ...
                        _c("td", [
                            ...
                            "button",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.openEditCategoryModal(category)
                                }
                              }
                            },
                            [_vm._v("Edit")]
                          ...
                          _c(
                            "button",
                            {
                              ...
                              on: {
                                click: function($event) {
                                  return _vm.openDeleteCategoryModal(
                                    category.id
                                  )
                                }
                              }
      ...
      [
        _c(
          "b-modal",
          {
            ...
            attrs: {
              id: "category-modal",
              title: _vm.editMode ? "Edit Category" : "Add Category"
            },
            on: {
              show: function($event) {
                _vm.editMode ? true : _vm.resetModal
              },
      ...
      [
        _c(
          "b-modal",
          {
            ...
            on: {
              ok: _vm.confirmDeleteCategory,
              cancel: _vm.cancelDeleteCategory
            },
            model: {
              value: _vm.deleteModalShow,
              callback: function($$v) {
                _vm.deleteModalShow = $$v
              },
              expression: "deleteModalShow"
            }
          },
          [
            _c("p", [
              _vm._v("¿Estás seguro de que deseas eliminar esta categoría?")
            ]),
            _vm._v(" "),
            _c("p", [_vm._v("ID: " + _vm._s(_vm.categoryIdToDelete))])
          ]
        )
      ],
      1
